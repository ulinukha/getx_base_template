...
import 'package:getx_base_template/app/base/constants/_index.dart';
...
class _Api extends GetConnect {
  ...
  Future<void> prepareHeader() async {
    ...
    httpClient.addRequestModifier<void>((request) async {
      if (_withToken) {
        String? token = pref.read(LocalData.PREF_TOKEN) ?? EMPTY;
        if (token.isNotBlank) {
  ...
  Future<Outcome> httpGet({
    ...
    if (withToken) print("TOKEN   : ${pref.read(LocalData.PREF_TOKEN)}");
